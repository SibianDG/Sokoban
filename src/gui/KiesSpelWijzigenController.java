...
public class KiesSpelWijzigenController extends GridPane{
    ...
    public KiesSpelWijzigenController(DomeinController domeinController, Vertaler vertaler, HoofdschermController vorigScherm) {
        super();
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("KiesSpelWijzigen.fxml"));
    ...
    private void stelStringInVolgensTaal(){
        ...
        txtInfo.setText(bundle.getString("kiesSpelInfo"));
    ...
    public void btnVolgendeOnAction(ActionEvent event)   {
        ...
        try {
            ...
            SpelActiesController spelActiesController = new SpelActiesController(domeinController, vertaler, this);
            Scene scene = new Scene(spelActiesController);
            Stage stage = (Stage) this.getScene().getWindow();
            stage.setTitle(vertaler.getBundle().getString("spelActies"));
    ...
    public HoofdschermController getHoofdscherm() {
    	return this.vorigScherm;
    }
}
